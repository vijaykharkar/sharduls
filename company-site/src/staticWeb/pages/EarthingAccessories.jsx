...
import product1 from '../../assets/productImages/earthingAccessories/earthingclamps.jpg';
import product2 from '../../assets/productImages/earthingAccessories/earthingstraps.jpg';
import product3 from '../../assets/productImages/earthingAccessories/earthingrods.jpg';
import product4 from '../../assets/productImages/earthingAccessories/earthingplates.jpg';
import product5 from '../../assets/productImages/earthingAccessories/earthbars.jpg';
import product6 from '../../assets/productImages/earthingAccessories/earthingconnectors.jpg';
import product7 from '../../assets/productImages/earthingAccessories/lightningarresters.jpg';


const EarthingAccessories = () => {
  ...
  const products = [
    {
      ...
      image: product1,
      description: 'Heavy-duty clamps for secure earthing connections in industrial applications',
      features: ['Copper & Brass', 'High Current Capacity', 'Corrosion Resistant', 'Easy Installation']
    },
    {
      name: 'Earthing Straps',
      image: product2,
      description: 'Flexible braided straps for grounding and bonding applications',
      features: ['Copper Braid', 'High Flexibility', 'Various Lengths', 'Tinned Options']
    },
    {
      name: 'Earthing Rods',
      image: product3,
      description: 'Solid copper bonded rods for effective ground electrode systems',
      features: ['Pure Copper', 'Various Lengths', 'Threaded Ends', 'High Conductivity']
    },
    {
      name: 'Earth Plates',
      image: product4,
      description: 'Large surface area copper plates for superior earthing resistance',
      features: ['Copper/GI', 'Various Sizes', 'Perforated Options', 'Long Life']
    },
    {
      name: 'Earth Bars',
      image: product5,
      description: 'Equipotential bonding bars for earthing distribution panels',
      features: ['Copper/Brass', 'Multiple Holes', 'Wall Mounting', 'High Current']
    },
    {
      name: 'Earthing Connectors',
      image: product6,
      description: 'Reliable connectors for earthing system installations',
      features: ['Compression Type', 'Exothermic Welding', 'Various Sizes', 'Low Resistance']
    },
    {
      name: 'Lightning Arresters',
      image: product7,
      description: 'Protection devices for lightning surge diversion',
      features: ['ESE Type', 'Conventional', 'High Protection', 'IEC Compliant']
    },
  ];
    ...
    <div ref={pageRef} className="min-h-screen">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 text-center">
          <div className="scroll-animate flex justify-center mb-6">
            <div className="w-16 h-16 bg-[#d4a853] rounded-xl flex items-center justify-center">
              <Zap className="text-[#1a3a5c]" size={32} />
            </div>
          </div>
          ...
          <h1 className="scroll-animate text-4xl md:text-5xl lg:text-6xl font-bold mb-6">
            ...
            <span className="text-[#d4a853]">Accessories</span>
          </h1>

          <p className="scroll-animate text-gray-300 text-base md:text-lg max-w-2xl mx-auto leading-relaxed mb-10">
            Ensure proper grounding and safeguard your electrical systems with reliable earthing
            clamps, straps, rods and plates for complete system protection.
          </p>
      ...
      <section className="py-20 bg-white">
        <div className="w-full mx-auto px-4">
          ...
          <h2 className="scroll-animate text-3xl md:text-4xl font-bold text-[#1a3a5c] mb-4 text-center italic">Earthing Accessories Products</h2>
...
export default EarthingAccessories;
