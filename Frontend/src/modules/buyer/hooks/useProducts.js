...
import MOCK_PRODUCTS from '@modules/buyer/data/mockProducts';
import productApi from '@modules/buyer/api/productApi';
...
export default function useProducts() {
  ...
  return {
    products: paginated, allProducts: filtered, loading,
    category, setCategory, brand, setBrand, sortBy, setSortBy,
    searchQuery, setSearchQuery, hasMore, loadMore, getById,
    totalCount: filtered.length, apiCategories, apiBrands,
  };
}
