...
const adminService = {
  ...
  updateSupplier: async (id, data) => {
    const res = await api.patch(`/admin/suppliers/${id}`, data);
    return res.data;
  },
  ...
  toggleStatus: async (id) => {
    const res = await api.post(`/admin/suppliers/${id}/toggle-status`);
    return res.data;
  },
  approveSupplier: async (id) => {
    const res = await api.post(`/admin/suppliers/${id}/approve`);
    return res.data;
  },
  rejectSupplier: async (id) => {
    const res = await api.post(`/admin/suppliers/${id}/reject`);
    return res.data;
  },
  submitReview: async (id, reviewData) => {
    const res = await api.post(`/admin/suppliers/${id}/review`, reviewData);
    return res.data;
  },
  getReview: async (id) => {
    const res = await api.get(`/admin/suppliers/${id}/review`);
    return res.data;
  },
  ...
  markNotificationRead: async (notifId) => {
    const res = await api.post(`/admin/notifications/${notifId}/read`);
    return res.data;
  },
  ...
  updateProductPricing: async (id, data) => {
    const res = await api.patch(`/admin/products/${id}/pricing`, data);
    return res.data;
  },
  ...
  bulkApproveProducts: async (productIds) => {
    const res = await api.post('/admin/products/bulk-approve', { product_ids: productIds });
    return res.data;
  },
