...
const LockedSection = ({ title }) => (
  <div className="bg-gray-50 rounded-2xl border-2 border-dashed border-gray-200 p-8 flex flex-col items-center justify-center text-center gap-3">
    ...
    <Link to="/supplier/profile" className="mt-1 text-xs text-violet-600 font-semibold hover:underline">
      Complete Profile →
    </Link>
  </div>
);
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        <Link to="/supplier/profile" className="hidden sm:inline-flex items-center gap-2 text-xs text-violet-600 font-semibold hover:text-violet-700 bg-violet-50 px-4 py-2 rounded-xl border border-violet-200 transition-colors">
      ...
      {hasReviewFeedback && !isApproved && (
        <motion.div initial={{ opacity: 0, y: -8 }} animate={{ opacity: 1, y: 0 }}
          ...
          <div className="flex items-center gap-3 px-6 py-4 border-b border-red-200">
            ...
            <Link to="/supplier/profile" className="flex items-center gap-1.5 px-4 py-2 bg-red-500 text-white text-xs font-bold rounded-xl hover:bg-red-600 transition-colors flex-shrink-0">
        ...
        <div className="relative bg-white rounded-2xl border border-gray-200 shadow-sm p-6 sm:p-8 overflow-hidden">
          ...
          <div className="flex flex-col lg:flex-row items-center gap-6 relative z-10">
            ...
            <div className="flex-1 text-center lg:text-left">
              ...
              <Link to="/supplier/profile" className="inline-flex items-center gap-2 px-5 py-2.5 bg-violet-600 text-white rounded-xl text-sm font-bold hover:bg-violet-700 transition-colors shadow-md">
      ...
      <div className="bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden">
        <div className="flex items-center justify-between px-6 py-4 border-b border-gray-100">
          ...
          <Link to="/supplier/profile" className="text-xs text-violet-600 font-semibold hover:text-violet-700 flex items-center gap-1">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        {isApproved ? (
          <>
            <div className="bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden">
              <div className="flex items-center justify-between px-5 py-4 border-b border-gray-100">
                ...
                <Link to="/supplier/orders" className="text-xs text-violet-600 font-semibold hover:text-violet-700 flex items-center gap-1">View All <ArrowRight size={12} /></Link>
              </div>
            ...
            <div className="bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden">
              <div className="flex items-center justify-between px-5 py-4 border-b border-gray-100">
                ...
                <Link to="/supplier/products" className="text-xs text-violet-600 font-semibold hover:text-violet-700 flex items-center gap-1">Manage <ArrowRight size={12} /></Link>
              </div>
              <div className="flex flex-col items-center justify-center py-12 text-center px-6">
                <Package size={36} className="text-gray-300 mb-3" />
                <p className="text-sm font-semibold text-gray-500">No products listed</p>
                <Link to="/supplier/products" className="mt-3 px-5 py-2 bg-violet-600 text-white text-xs font-bold rounded-xl hover:bg-violet-700 transition-colors">
          ...
          <>
            <LockedSection title="Recent Orders" />
            <LockedSection title="Products" />
          </>
        )}
      </div>
    </div>
