...
import { validateIFSC, lookupIFSC } from '@shared/utils/helpers';
  ...
  const handleSave = async () => {
    ...
    try {
      const res = await profileService.saveBankDetails({
        account_holder_name: form.holderName, account_number: form.acctNumber,
        account_type: form.acctType, ifsc_code: form.ifsc,
        bank_name: form.bankName || null, branch: form.branch || null,
        city: form.city || null, cheque_file_url: null,
      });
